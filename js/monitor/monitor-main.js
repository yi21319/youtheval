...
let monitorSystemUser = null;

function initMonitorSystem(user) {
    monitorSystemUser = user;
        ...
        <div class="student-container">
            ...
            <div class="sidebar">
                ...
                <div class="robot-area">
                    <div class="student-robot-icon" id="monitor-robot-icon">
                        <i class="fas fa-robot"></i>
                    </div>
                    <p>智能助手</p>
                </div>
                <a href="#" class="logout-btn" id="monitorLogoutBtn">
...
function initMonitorNavigation() {
    ...
    const pageContainers = document.querySelectorAll('#monitorSystem .page-container');
