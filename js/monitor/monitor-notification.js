...
function loadMonitorNotifications() {
    const stored = localStorage.getItem('monitorNotifications');
    if (stored) {
        ...
        localStorage.setItem('monitorNotifications', JSON.stringify(monitorNotifications));
    }
...
function renderMonitorNotifications() {
    ...
    container.innerHTML = `
        <div class="section">
            ...
            <ul class="notification-list" id="monitor-notification-list"></ul>
        </div>
    `;
    ...
    monitorNotifications.forEach(notification => {
        ...
        `;
        li.addEventListener('click', () => showMonitorNotificationDetail(notification));
    ...
    if (markAllBtn) {
        markAllBtn.addEventListener('click', () => {
            monitorNotifications.forEach(n => n.read = true);
            localStorage.setItem('monitorNotifications', JSON.stringify(monitorNotifications));
            renderMonitorNotifications();
